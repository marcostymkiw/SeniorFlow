const CACHE_NAME = 'seniorflow-react-20260630-stock-app-04';
const ASSETS = [
  './',
  './index.html',
  './stock-app.html',
  './stock-app.js?v=seniorflow-react-20260630-stock-app-04',
  './app.js?v=seniorflow-react-20260630-stock-app-04',
  './firebase-config.js?v=seniorflow-react-20260630-stock-app-04',
  './manifest.json',
  './manifest-stock-app.json',
  './sw-stock-app.js?v=seniorflow-react-20260630-stock-app-04',
  './ofertas.html?v=seniorflow-react-20260630-stock-app-04',
