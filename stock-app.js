import { auth, db } from './firebase-config.js?v=seniorflow-react-20260630-stock-app-03';
...
if ('serviceWorker' in navigator && window.location.protocol !== 'file:') {
  navigator.serviceWorker.register('./sw-stock-app.js?v=seniorflow-react-20260630-stock-app-03').catch(console.warn);
}
